...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rancho da Vila - Self-Service em Vila Arens, Jundiaí" },
      ...
      { property: "og:title", content: "Rancho da Vila - Self-Service em Vila Arens, Jundiaí" },
      ...
      { name: "twitter:title", content: "Rancho da Vila - Self-Service em Vila Arens, Jundiaí" },
