...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Rancho Da Vila Arens — Comida caseira em Vila Arens" },
      { property: "og:description", content: "Self-service, marmitex e drive-through em Vila Arens, Jundiaí." },
